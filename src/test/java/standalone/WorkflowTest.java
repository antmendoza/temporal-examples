...
public class WorkflowTest {
    ...
    public static class ChildWfImpl implements ChildWf {
        ...
        public void start() {
            ...
            IWorkflow parent =   Workflow.newExternalWorkflowStub(IWorkflow.class, Workflow.getInfo().getParentWorkflowId().get());

            parent.signalFromChild("signaled_1");


            io.temporal.workflow.Workflow.await(() -> this.signaled_2);
